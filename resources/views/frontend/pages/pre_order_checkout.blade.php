...
@section('main_content')
    ...
    <main class="bg_gray">
        ...
        <div class="container margin_30">
            ...
            <!-- /page_header -->
            <form action="{!! route('frontend.pre-order-checkout', ['product_id' => $product->id, 'quantity' => $totalQty]) !!}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-lg-8 col-md-8">
                        <div class="step first payments">
                            ...
                            <div class="box_general summary">
                                <ul>
                                    <li class="clearfix"><em>{!! $totalQty !!}x {!! $product->title !!} </em>  <span>{!! $product->sell_price !!} Tk.</span></li>
                                </ul>
                                <ul>
                                    <li class="clearfix"><em><strong>Subtotal</strong></em>  <span>{!! ($product->sell_price * $totalQty) !!} Tk.</span></li>
                                    <li class="clearfix"><em><strong>Shipping</strong></em> <span>$0</span></li>

                                </ul>
                                <div class="total clearfix">TOTAL <span>{!! ($product->sell_price * $totalQty) !!} Tk.</span></div>
                            </div>
                            <!-- /box_general -->
                        </div>
                        <!-- /step -->
