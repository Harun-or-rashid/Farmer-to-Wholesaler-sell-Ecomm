...
--
-- Database: `clientprojects_allaia`
--
...
CREATE TABLE `districts` (
  ...
  `bn_name` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(4, '2020_02_05_155910_create_divisions_table', 1),
(5, '2020_02_05_155918_create_districts_table', 1),
(6, '2020_02_05_161004_create_upazilas_table', 1),
(7, '2020_02_05_161018_create_unions_table', 1),
(8, '2020_02_07_142153_create_system_settings_table', 1),
(9, '2020_02_07_183706_create_product_categories_table', 1),
(10, '2020_02_10_164625_create_products_table', 1),
(11, '2020_02_12_165905_create_product_colors_table', 1),
(12, '2020_02_12_165941_create_product_stocks_table', 1),
(13, '2020_02_16_175226_create_product_images_table', 1),
(14, '2020_02_22_160224_create_product_stock_input_histories_table', 1),
(15, '2020_05_04_170308_create_product_reviews_table', 1),
(16, '2020_06_16_205928_create_user_addresses_table', 1),
(17, '2020_12_29_213622_create_website_information_table', 2),
(18, '2020_12_29_213555_create_page_abouts_table', 3),
(19, '2021_01_03_210457_create_page_contacts_table', 3),
(20, '2021_02_06_125940_add_featured_and_image_column_in_product_categories_table', 4),
(21, '2021_03_05_143849_create_orders_table', 5),
(22, '2021_03_05_154941_create_order_details_table', 5),
(25, '2021_03_05_155304_create_payment_details_table', 6),
(26, '2021_03_12_111058_add_emi_available_column_in_products_table', 7),
(27, '2021_03_13_040508_add_published_column_in_products_table', 8),
(28, '2021_03_13_053441_add_total_sell_column_in_products_table', 9),
(29, '2021_03_19_024512_add_order_type_column_in_orders_table', 10),
(31, '2021_10_02_114522_add_in_slider_column_in_products_table', 11);
...
CREATE TABLE `orders` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `order_id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'unique order id',
  `user_id` int(10) UNSIGNED NOT NULL,
  `user_address_id` int(10) UNSIGNED NOT NULL,
  `order_type` tinyint(4) NOT NULL DEFAULT '1' COMMENT '1=normal order,2=pre order',
  `sub_total` decimal(10,2) NOT NULL,
  `product_discount` decimal(10,2) NOT NULL DEFAULT '0.00',
  `overall_discount` decimal(10,2) NOT NULL DEFAULT '0.00',
  `discount_reference` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'reference id or 0=nothing',
  `discount_type` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0=nothing,1=coupon',
  `total_discount` decimal(10,2) NOT NULL DEFAULT '0.00',
  `delivery_charge` decimal(10,2) NOT NULL,
  `payable_amount` decimal(10,2) NOT NULL,
  `paid_amount` decimal(10,2) NOT NULL DEFAULT '0.00',
  `payment_method` int(10) UNSIGNED NOT NULL DEFAULT '1' COMMENT '1=cash-on-delivery,2=card,3=mobile-bank',
  `payment_status` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0=pending, 1=paid, 2=partial paid',
  `order_status` tinyint(4) NOT NULL COMMENT '1=Pending, 2=Accept, 3=Rejected,Cancel',
  `delivery_method` tinyint(4) NOT NULL DEFAULT '1' COMMENT 'delivery method',
  `delivery_status` tinyint(4) NOT NULL COMMENT '1=Waiting For Received, 2=Delivered',
...
INSERT INTO `orders` (`id`, `order_id`, `user_id`, `user_address_id`, `order_type`, `sub_total`, `product_discount`, `overall_discount`, `discount_reference`, `discount_type`, `total_discount`, `delivery_charge`, `payable_amount`, `paid_amount`, `payment_method`, `payment_status`, `order_status`, `delivery_method`, `delivery_status`, `status`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted`, `deleted_at`, `deleted_by`) VALUES
(2, '3626130703211', 2, 1, 1, '1600.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '1600.00', '0.00', 1, 0, 2, 1, 3, 1, '2021-03-07 07:26:36', 2, NULL, NULL, 0, NULL, NULL),
(3, '5327130703212', 2, 1, 1, '1600.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '1600.00', '0.00', 1, 0, 3, 1, 1, 1, '2021-03-07 07:27:53', 2, NULL, NULL, 0, NULL, NULL),
(4, '5827130703213', 2, 1, 1, '1600.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '1600.00', '0.00', 1, 0, 1, 1, 1, 1, '2021-03-07 07:27:58', 2, NULL, NULL, 0, NULL, NULL),
(5, '3728130703214', 2, 1, 1, '1600.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '1600.00', '0.00', 1, 0, 1, 1, 1, 1, '2021-03-07 07:28:37', 2, NULL, NULL, 0, NULL, NULL),
(6, '1129130703215', 2, 1, 1, '1600.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '1600.00', '0.00', 1, 0, 1, 1, 1, 1, '2021-03-07 07:29:11', 2, NULL, NULL, 0, NULL, NULL),
(7, '2829130703216', 2, 1, 1, '1600.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '1600.00', '0.00', 1, 0, 1, 1, 1, 1, '2021-03-07 07:29:28', 2, NULL, NULL, 0, NULL, NULL),
(8, '1601140803217', 2, 1, 1, '2400.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '2400.00', '0.00', 1, 0, 1, 1, 1, 1, '2021-03-08 08:01:16', 2, NULL, NULL, 0, NULL, NULL),
(9, '2801140803218', 2, 1, 1, '2400.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '2400.00', '0.00', 1, 0, 1, 1, 1, 1, '2021-03-08 08:01:28', 2, NULL, NULL, 0, NULL, NULL),
(10, '5001150803219', 2, 1, 1, '2400.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '2400.00', '0.00', 1, 0, 1, 1, 1, 1, '2021-03-08 09:01:50', 2, NULL, NULL, 0, NULL, NULL),
(11, '05550409032110', 2, 1, 1, '800.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '800.00', '0.00', 1, 0, 1, 1, 1, 1, '2021-03-08 22:55:05', 2, NULL, NULL, 0, NULL, NULL),
(12, '08321809032111', 2, 1, 1, '800.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '800.00', '800.00', 2, 1, 2, 1, 1, 1, '2021-03-09 12:32:08', 2, NULL, NULL, 0, NULL, NULL),
(13, '06411809032112', 2, 1, 1, '800.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '800.00', '0.00', 2, 0, 1, 1, 1, 1, '2021-03-09 12:41:06', 2, NULL, NULL, 0, NULL, NULL),
(14, '20251012032113', 2, 1, 1, '800.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '800.00', '800.00', 2, 1, 1, 1, 1, 1, '2021-03-12 04:25:20', 2, NULL, NULL, 0, NULL, NULL),
(15, '10311112032114', 2, 1, 1, '8800.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '8800.00', '0.00', 2, 0, 1, 1, 1, 1, '2021-03-12 05:31:10', 2, NULL, NULL, 0, NULL, NULL),
(16, '49120419032115', 2, 1, 2, '8200.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '8200.00', '8200.00', 2, 1, 2, 1, 3, 1, '2021-03-18 22:12:49', 2, NULL, NULL, 0, NULL, NULL),
(17, '18200419032116', 2, 1, 1, '8200.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '8200.00', '0.00', 2, 0, 2, 1, 3, 1, '2021-03-18 22:20:18', 2, NULL, NULL, 0, NULL, NULL),
(18, '48111626092117', 2, 1, 1, '800.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '800.00', '0.00', 3, 0, 1, 1, 1, 1, '2021-09-26 10:11:48', 2, NULL, NULL, 0, NULL, NULL),
(19, '30080206102118', 2, 1, 2, '500.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '500.00', '0.00', 1, 0, 1, 1, 1, 1, '2021-10-05 20:08:30', 2, NULL, NULL, 0, NULL, NULL),
(20, '38080206102119', 2, 1, 2, '500.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '500.00', '0.00', 1, 0, 1, 1, 1, 1, '2021-10-05 20:08:38', 2, NULL, NULL, 0, NULL, NULL),
(21, '43160206102120', 2, 1, 2, '500.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '500.00', '0.00', 1, 0, 1, 1, 1, 1, '2021-10-05 20:16:43', 2, NULL, NULL, 0, NULL, NULL),
(22, '08170206102121', 2, 1, 1, '8200.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '8200.00', '0.00', 1, 0, 1, 1, 1, 1, '2021-10-05 20:17:08', 2, NULL, NULL, 0, NULL, NULL),
(23, '45180206102122', 2, 1, 1, '8200.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '8200.00', '0.00', 1, 0, 1, 1, 1, 1, '2021-10-05 20:18:45', 2, NULL, NULL, 0, NULL, NULL),
(24, '00190206102123', 2, 1, 1, '8200.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '8200.00', '0.00', 1, 0, 1, 1, 1, 1, '2021-10-05 20:19:00', 2, NULL, NULL, 0, NULL, NULL),
(25, '14200206102124', 2, 1, 1, '8200.00', '0.00', '0.00', 0, 0, '0.00', '0.00', '8200.00', '8200.00', 2, 1, 1, 1, 1, 1, '2021-10-05 20:20:14', 2, NULL, NULL, 0, NULL, NULL);
...
CREATE TABLE `order_details` (
  ...
  `payable_amount` decimal(10,2) NOT NULL,
  `product_type` tinyint(4) NOT NULL DEFAULT '1' COMMENT '1=product, 2=delivery charge',
  `status` tinyint(3) UNSIGNED NOT NULL DEFAULT '1' COMMENT '0=Inactive,1=Active',
  `created_at` timestamp NULL DEFAULT NULL,
  `created_by` int(10) UNSIGNED DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `order_details` (`id`, `order_id`, `user_id`, `product_id`, `stock_id`, `quantity`, `price`, `discount`, `payable_amount`, `product_type`, `status`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted`, `deleted_at`, `deleted_by`) VALUES
(1, 2, 2, 5, 1, '2.00', '800.00', '0.00', '1600.00', 1, 1, '2021-03-07 07:26:36', 2, NULL, NULL, 0, NULL, NULL),
(2, 2, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-03-07 07:26:36', 2, NULL, NULL, 0, NULL, NULL),
(3, 3, 2, 5, 1, '2.00', '800.00', '0.00', '1600.00', 1, 1, '2021-03-07 07:27:53', 2, NULL, NULL, 0, NULL, NULL),
(4, 3, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-03-07 07:27:53', 2, NULL, NULL, 0, NULL, NULL),
(5, 4, 2, 5, 1, '2.00', '800.00', '0.00', '1600.00', 1, 1, '2021-03-07 07:27:58', 2, NULL, NULL, 0, NULL, NULL),
(6, 4, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-03-07 07:27:58', 2, NULL, NULL, 0, NULL, NULL),
(7, 5, 2, 5, 1, '2.00', '800.00', '0.00', '1600.00', 1, 1, '2021-03-07 07:28:37', 2, NULL, NULL, 0, NULL, NULL),
(8, 5, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-03-07 07:28:37', 2, NULL, NULL, 0, NULL, NULL),
(9, 6, 2, 5, 1, '2.00', '800.00', '0.00', '1600.00', 1, 1, '2021-03-07 07:29:11', 2, NULL, NULL, 0, NULL, NULL),
(10, 6, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-03-07 07:29:11', 2, NULL, NULL, 0, NULL, NULL),
(11, 7, 2, 5, 1, '2.00', '800.00', '0.00', '1600.00', 1, 1, '2021-03-07 07:29:28', 2, NULL, NULL, 0, NULL, NULL),
(12, 7, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-03-07 07:29:28', 2, NULL, NULL, 0, NULL, NULL),
(13, 8, 2, 5, 1, '3.00', '800.00', '0.00', '2400.00', 1, 1, '2021-03-08 08:01:16', 2, NULL, NULL, 0, NULL, NULL),
(14, 8, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-03-08 08:01:16', 2, NULL, NULL, 0, NULL, NULL),
(15, 9, 2, 5, 1, '3.00', '800.00', '0.00', '2400.00', 1, 1, '2021-03-08 08:01:28', 2, NULL, NULL, 0, NULL, NULL),
(16, 9, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-03-08 08:01:28', 2, NULL, NULL, 0, NULL, NULL),
(17, 10, 2, 5, 1, '3.00', '800.00', '0.00', '2400.00', 1, 1, '2021-03-08 09:01:50', 2, NULL, NULL, 0, NULL, NULL),
(18, 10, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-03-08 09:01:50', 2, NULL, NULL, 0, NULL, NULL),
(19, 11, 2, 5, 2, '1.00', '800.00', '0.00', '800.00', 1, 1, '2021-03-08 22:55:05', 2, NULL, NULL, 0, NULL, NULL),
(20, 11, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-03-08 22:55:05', 2, NULL, NULL, 0, NULL, NULL),
(21, 12, 2, 5, 2, '1.00', '800.00', '0.00', '800.00', 1, 1, '2021-03-09 12:32:08', 2, NULL, NULL, 0, NULL, NULL),
(22, 12, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-03-09 12:32:08', 2, NULL, NULL, 0, NULL, NULL),
(23, 13, 2, 5, 1, '1.00', '800.00', '0.00', '800.00', 1, 1, '2021-03-09 12:41:06', 2, NULL, NULL, 0, NULL, NULL),
(24, 13, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-03-09 12:41:06', 2, NULL, NULL, 0, NULL, NULL),
(25, 14, 2, 5, 1, '1.00', '800.00', '0.00', '800.00', 1, 1, '2021-03-12 04:25:20', 2, NULL, NULL, 0, NULL, NULL),
(26, 14, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-03-12 04:25:20', 2, NULL, NULL, 0, NULL, NULL),
(27, 15, 2, 5, 1, '8.00', '800.00', '0.00', '6400.00', 1, 1, '2021-03-12 05:31:10', 2, NULL, NULL, 0, NULL, NULL),
(28, 15, 2, 5, 2, '3.00', '800.00', '0.00', '2400.00', 1, 1, '2021-03-12 05:31:10', 2, NULL, NULL, 0, NULL, NULL),
(29, 15, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-03-12 05:31:10', 2, NULL, NULL, 0, NULL, NULL),
(30, 16, 2, 9, 0, '1.00', '8200.00', '0.00', '8200.00', 1, 1, '2021-03-18 22:12:49', 2, NULL, NULL, 0, NULL, NULL),
(31, 16, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-03-18 22:12:49', 2, NULL, NULL, 0, NULL, NULL),
(32, 17, 2, 9, 3, '1.00', '8200.00', '0.00', '8200.00', 1, 1, '2021-03-18 22:20:18', 2, NULL, NULL, 0, NULL, NULL),
(33, 17, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-03-18 22:20:18', 2, NULL, NULL, 0, NULL, NULL),
(34, 18, 2, 5, 1, '1.00', '800.00', '0.00', '800.00', 1, 1, '2021-09-26 10:11:48', 2, NULL, NULL, 0, NULL, NULL),
(35, 18, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-09-26 10:11:48', 2, NULL, NULL, 0, NULL, NULL),
(36, 19, 2, 10, 0, '1.00', '500.00', '0.00', '500.00', 1, 1, '2021-10-05 20:08:30', 2, NULL, NULL, 0, NULL, NULL),
(37, 19, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-10-05 20:08:30', 2, NULL, NULL, 0, NULL, NULL),
(38, 20, 2, 10, 0, '1.00', '500.00', '0.00', '500.00', 1, 1, '2021-10-05 20:08:38', 2, NULL, NULL, 0, NULL, NULL),
(39, 20, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-10-05 20:08:38', 2, NULL, NULL, 0, NULL, NULL),
(40, 21, 2, 10, 0, '1.00', '500.00', '0.00', '500.00', 1, 1, '2021-10-05 20:16:43', 2, NULL, NULL, 0, NULL, NULL),
(41, 21, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-10-05 20:16:43', 2, NULL, NULL, 0, NULL, NULL),
(42, 22, 2, 9, 3, '1.00', '8200.00', '0.00', '8200.00', 1, 1, '2021-10-05 20:17:08', 2, NULL, NULL, 0, NULL, NULL),
(43, 22, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-10-05 20:17:08', 2, NULL, NULL, 0, NULL, NULL),
(44, 23, 2, 9, 3, '1.00', '8200.00', '0.00', '8200.00', 1, 1, '2021-10-05 20:18:45', 2, NULL, NULL, 0, NULL, NULL),
(45, 23, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-10-05 20:18:45', 2, NULL, NULL, 0, NULL, NULL),
(46, 24, 2, 9, 3, '1.00', '8200.00', '0.00', '8200.00', 1, 1, '2021-10-05 20:19:00', 2, NULL, NULL, 0, NULL, NULL),
(47, 24, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-10-05 20:19:00', 2, NULL, NULL, 0, NULL, NULL),
(48, 25, 2, 9, 3, '1.00', '8200.00', '0.00', '8200.00', 1, 1, '2021-10-05 20:20:14', 2, NULL, NULL, 0, NULL, NULL),
(49, 25, 2, NULL, NULL, '1.00', '0.00', '0.00', '0.00', 2, 1, '2021-10-05 20:20:14', 2, NULL, NULL, 0, NULL, NULL);
...
INSERT INTO `page_abouts` (`id`, `about_text`, `image`, `status`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted`, `deleted_at`, `deleted_by`) VALUES
(1, '<h2>Top Products</h2>\r\n\r\n<p>Est falli invenire interpretaris id, magna libris sensibus mel id.</p>\r\n\r\n<p>Per eu nostrud feugiat. Et quo molestiae persecuti neglegentur. At zril definitionem mei, vel ei choro volumus. An tota nulla soluta has, ei nec essent audiam, te nisl dignissim vel. Ex velit audire perfecto pro, ei mei doming vivendo legendos. Cu sit magna zril, an odio delectus constituto vis. Vis ludus omnesque ne, est veri quaeque ad</p>', 'uploads/page/about_image_15847.jpg', 1, '2021-02-02 09:01:20', 1, NULL, NULL, 0, NULL, NULL);
...
CREATE TABLE `page_contacts` (
  ...
  `office_phone` varchar(225) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fax` varchar(225) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `support_mail` varchar(225) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contact_mail` varchar(225) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` tinyint(3) UNSIGNED NOT NULL DEFAULT '0' COMMENT '0=Inactive,1=Active',
  `created_at` timestamp NULL DEFAULT NULL,
  `created_by` int(10) UNSIGNED DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `page_contacts` (`id`, `contact_text`, `address`, `office_phone`, `fax`, `support_mail`, `contact_mail`, `status`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted`, `deleted_at`, `deleted_by`) VALUES
(1, '<h2>Top Products</h2>\r\n\r\n<p>Est falli invenire interpretaris id, magna libris sensibus mel id.</p>\r\n\r\n<p>Per eu nostrud feugiat. Et quo molestiae persecuti neglegentur. At zril definitionem mei, vel ei choro volumus. An tota nulla soluta has, ei nec essent audiam, te nisl dignissim vel. Ex velit audire perfecto pro, ei mei doming vivendo legendos. Cu sit magna zril, an odio delectus constituto vis. Vis ludus omnesque ne, est veri quaeque ad</p>', 'Ut qui eum debitis m', '+1 (794) 123-3251', '+1 (197) 968-2062', 'gyjok@mailinator.com', 'tojijamos@mailinator.com', 1, '2021-02-02 09:01:36', 1, NULL, NULL, 0, NULL, NULL);
...
CREATE TABLE `payment_details` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `tran_id` varchar(128) COLLATE utf8mb4_unicode_ci NOT NULL,
  `order_id` int(10) UNSIGNED NOT NULL,
  `val_id` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `amount` decimal(10,2) NOT NULL DEFAULT '0.00',
  `store_amount` decimal(10,2) NOT NULL DEFAULT '0.00',
  `card_type` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `card_no` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `bank_tran_id` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `transaction_status` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `card_issuer` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `card_brand` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `card_sub_brand` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `card_issuer_country` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `card_issuer_country_code` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `store_id` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `currency_type` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `risk_title` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` tinyint(3) UNSIGNED NOT NULL DEFAULT '1' COMMENT '0=Inactive,1=Active,2=Invalid Payment',
  `created_at` timestamp NULL DEFAULT NULL,
  `created_by` int(10) UNSIGNED DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `updated_by` int(10) UNSIGNED DEFAULT NULL,
...
INSERT INTO `payment_details` (`id`, `tran_id`, `order_id`, `val_id`, `amount`, `store_amount`, `card_type`, `card_no`, `bank_tran_id`, `transaction_status`, `tran_date`, `error`, `currency`, `card_issuer`, `card_brand`, `card_sub_brand`, `card_issuer_country`, `card_issuer_country_code`, `store_id`, `currency_type`, `currency_amount`, `currency_rate`, `base_fair`, `risk_level`, `risk_title`, `status`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted`, `deleted_at`, `deleted_by`) VALUES
(1, '0649180903211', 12, '210310053591nHVbVHxuo9Fr19', '800.00', '780.00', 'BKASH-BKash', NULL, '21031005359043mRJ6EWJSZ6bh', 'VALID', '2021-03-09 18:53:54', NULL, 'BDT', 'BKash Mobile Banking', 'MOBILEBANKING', 'Classic', 'Bangladesh', 'BD', 'gonot5f0094e9cdbb0', 'BDT', '800.00', '1.00', '0.00', '0', 'Safe', 1, '2021-03-09 12:49:17', 2, NULL, NULL, 0, NULL, NULL),
(2, '0404111203212', 14, '2103121709091vjMHcM9wGq4xKE', '800.00', '780.00', 'BKASH-BKash', NULL, '210312170909A7Ry7jo0VX6t47g', 'VALID', '2021-03-12 11:08:56', NULL, 'BDT', 'BKash Mobile Banking', 'MOBILEBANKING', 'Classic', 'Bangladesh', 'BD', 'gonot5f0094e9cdbb0', 'BDT', '800.00', '1.00', '0.00', '0', 'Safe', 1, '2021-03-12 05:04:24', 2, NULL, NULL, 0, NULL, NULL),
(3, '5912041903213', 16, '210319101815olHZODbGN0V9vKd', '8200.00', '7995.00', 'NAGAD-Nagad', NULL, '2103191018150Xm0fR4jkrwhqS4', 'VALID', '2021-03-19 04:18:03', NULL, 'BDT', 'Nagad', 'MOBILEBANKING', 'Classic', 'Bangladesh', 'BD', 'gonot5f0094e9cdbb0', 'BDT', '8200.00', '1.00', '0.00', '0', 'Safe', 1, '2021-03-18 22:13:17', 2, NULL, NULL, 0, NULL, NULL),
(4, '2520020610214', 25, '21100682133aYI2g3tRFAIfvzu', '8200.00', '7995.00', 'BKASH-BKash', NULL, '2110068213303uLmofCLXc7M3D', 'VALID', '2021-10-06 02:20:15', NULL, 'BDT', 'BKash Mobile Banking', 'MOBILEBANKING', 'Classic', 'Bangladesh', 'BD', 'gonot5f0094e9cdbb0', 'BDT', '8200.00', '1.00', '0.00', '0', 'Safe', 1, '2021-10-05 20:21:46', 2, NULL, NULL, 0, NULL, NULL);
...
CREATE TABLE `products` (
  ...
  `quick_text` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `product_details` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `manufacturer` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `weight` double(8,2) NOT NULL DEFAULT '0.00',
  `featured` tinyint(4) NOT NULL DEFAULT '0',
  `emi_available` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0=no-emi,1=avail EMI',
  `published` tinyint(4) NOT NULL DEFAULT '1' COMMENT '1=published,2=upcoming',
  `upcoming_text` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slider` tinyint(4) NOT NULL DEFAULT '0' COMMENT '1=yes,0=no',
  `product_price` double(8,2) NOT NULL DEFAULT '0.00',
  `sell_price` double(8,2) NOT NULL DEFAULT '0.00',
  `total_sell` int(10) UNSIGNED DEFAULT NULL,
  `status` tinyint(3) UNSIGNED NOT NULL DEFAULT '0' COMMENT '0=Inactive,1=Active,2=Pending',
  `created_at` timestamp NULL DEFAULT NULL,
  `created_by` int(10) UNSIGNED DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `updated_by` int(10) UNSIGNED DEFAULT NULL,
...
INSERT INTO `products` (`id`, `product_category_id`, `title`, `slug`, `quick_text`, `product_details`, `manufacturer`, `weight`, `featured`, `emi_available`, `published`, `upcoming_text`, `slider`, `product_price`, `sell_price`, `total_sell`, `status`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted`, `deleted_at`, `deleted_by`) VALUES
(5, 4, 'Reiciendis amet dol', 'reiciendis-amet-dol-3', '<p><strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#39;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type s</p>', '<h2>Why do we use it?</h2>\r\n\r\n<p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using &#39;Content here, content here&#39;, making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for &#39;lorem ipsum&#39; will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p>', NULL, 0.00, 1, 0, 1, NULL, 0, 835.00, 800.00, NULL, 1, '2021-02-01 11:02:58', 1, '2021-02-01 12:49:44', 1, 0, NULL, NULL),
(6, 4, 'JIJ kljsf sfj', 'jij-kljsf-sfj-2', '<p><strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#39;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type s</p>', '<h2>Why do we use it?</h2>\r\n\r\n<p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using &#39;Content here, content here&#39;, making it look like readable English. Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for &#39;lorem ipsum&#39; will uncover many web sites still in their infancy. Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p>', NULL, 0.00, 1, 0, 1, NULL, 0, 835.00, 61.00, NULL, 1, '2021-02-01 11:03:53', 1, '2021-10-02 05:57:51', 1, 0, NULL, NULL),
(7, 4, 'Ut distinctio Error', 'ut-distinctio-error-2', '<p>Lorem ipsum dolor sit amet, his no adipisci pericula conclusionemque. Qui labore salutandi ex, vivendum argumentum mediocritatem vis eu, viris tritani per id. At iudicabit maluisset vis, dicant diceret pri cu. Cum at rebum vulputate forensibus, eruditi principes ad vel, pro denique recusabo at. Ubique nominavi delicata sit cu, quo no reque insolens suscipiantur.</p>\r\n\r\n<p>Et phaedrum temporibus per. Antiopam posidonium et est. Eu ius quas modus suavitate, ex sea feugiat laoreet voluptatum. Quo at veritus ancillae complectitur, duo no assum omnes.</p>', '<h3>Details</h3>\r\n\r\n<p>Lorem ipsum dolor sit amet, in eleifend&nbsp;<strong>inimicus elaboraret</strong>&nbsp;his, harum efficiendi mel ne. Sale percipit vituperata ex mel, sea ne essent aeterno sanctus, nam ea laoreet civibus electram. Ea vis eius explicari. Quot iuvaret ad has.</p>\r\n\r\n<p>Vis ei ipsum conclusionemque. Te enim suscipit recusabo mea, ne vis mazim aliquando, everti insolens at sit. Cu vel modo unum quaestio, in vide dicta has. Ut his laudem explicari adversarium, nisl&nbsp;<strong>laboramus hendrerit</strong>&nbsp;te his, alia lobortis vis ea.</p>\r\n\r\n<p>Perfecto eleifend sea no, cu audire voluptatibus eam. An alii praesent sit, nobis numquam principes ea eos, cu autem constituto suscipiantur eam. Ex graeci elaboraret pro. Mei te omnis tantas, nobis viderer vivendo ex has.</p>', NULL, 0.00, 1, 0, 1, NULL, 1, 100.00, 80.00, NULL, 1, '2021-02-06 08:24:01', 1, '2021-10-02 05:54:14', 1, 0, NULL, NULL),
(8, 10, 'Voluptatibus minim e', 'voluptatibus-minim-e-2', '<h2>What is Lorem Ipsum?</h2>\r\n\r\n<p><strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#39;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>', '<h2>Where can I get some?</h2>\r\n\r\n<p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don&#39;t look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn&#39;t anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.</p>', NULL, 0.00, 1, 0, 2, 'Coming Soon', 1, 15000.00, 14500.00, NULL, 1, '2021-03-12 23:11:23', 1, '2021-10-02 05:50:09', 1, 0, NULL, NULL),
(9, 4, 'Ratione laboriosam', 'ratione-laboriosam', '<p>afsd</p>', '<p>sadf</p>', NULL, 0.00, 1, 1, 1, NULL, 0, 8500.00, 8200.00, NULL, 1, '2021-03-18 10:16:57', 1, NULL, NULL, 0, NULL, NULL),
(10, 11, 'Product -Oct-6', 'product--oct-6', '<h2>What is Lorem Ipsum?</h2>\r\n\r\n<p><strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#39;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sh</p>', '<h2>What is Lorem Ipsum?</h2>\r\n\r\n<p><strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#39;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sh</p>\r\n\r\n<h2>What is Lorem Ipsum?</h2>\r\n\r\n<p><strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#39;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sh</p>\r\n\r\n<h2>What is Lorem Ipsum?</h2>\r\n\r\n<p><strong>Lorem Ipsum</strong>&nbsp;is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry&#39;s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sh</p>', NULL, 0.00, 1, 0, 1, NULL, 1, 500.00, 500.00, NULL, 1, '2021-10-05 20:05:58', 1, NULL, NULL, 0, NULL, NULL);
...
CREATE TABLE `product_categories` (
  ...
  `image` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'category image',
  `featured` tinyint(4) NOT NULL DEFAULT '0' COMMENT '1=featured',
  `status` tinyint(3) UNSIGNED NOT NULL DEFAULT '0' COMMENT '0=Inactive,1=Active',
  `created_at` timestamp NULL DEFAULT NULL,
  `created_by` int(10) UNSIGNED DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `product_categories` (`id`, `title`, `slug`, `parent_id`, `image`, `featured`, `status`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted`, `deleted_at`, `deleted_by`) VALUES
(1, 'Mens Collection', 'mens-collection', 0, NULL, 1, 1, '2021-02-01 09:55:01', 1, NULL, NULL, 0, NULL, NULL),
(2, 'Women\'s Collection', 'womens-collection', 0, NULL, 1, 1, '2021-02-01 09:49:45', 1, NULL, NULL, 0, NULL, NULL),
(3, 'Cat-3', 'cat-3', 0, NULL, 0, 1, '2021-02-01 09:50:03', 1, NULL, NULL, 0, NULL, NULL),
(4, 'Cat-1-1', 'cat-1-1-2', 1, NULL, 0, 1, '2021-02-01 09:55:43', 1, NULL, NULL, 0, NULL, NULL),
(5, 'Cat-4', 'cat-4', 0, 'uploads/category/category_image_16971.jpg', 0, 1, '2021-02-06 07:20:17', 1, NULL, NULL, 0, NULL, NULL),
(6, 'Distinctio Sed elit', 'distinctio-sed-elit-2', 0, 'uploads/category/category_image_11423.png', 0, 1, '2021-02-06 07:50:01', 1, NULL, NULL, 0, NULL, NULL),
(7, 'Calista Wehner', 'calista-wehner', 2, NULL, 0, 1, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(8, 'Alexa Ernser', 'alexa-ernser', 3, NULL, 0, 1, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(9, 'Dr. Noemi Konopelski', 'dr-noemi-konopelski', 3, NULL, 0, 1, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(10, 'Fidel Streich DDS', 'fidel-streich-dds', 2, NULL, 0, 1, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(11, 'Frederik Larson', 'frederik-larson', 1, NULL, 0, 1, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(12, 'Otha Zulauf DVM', 'otha-zulauf-dvm', 1, NULL, 0, 1, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(13, 'Cale Witting I', 'cale-witting-i', 1, NULL, 0, 1, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(14, 'Derek Balistreri', 'derek-balistreri', 1, NULL, 0, 1, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(15, 'Lloyd Cruickshank', 'lloyd-cruickshank', 2, NULL, 0, 1, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(16, 'Jennings Beatty', 'jennings-beatty', 2, NULL, 0, 1, NULL, NULL, NULL, NULL, 0, NULL, NULL),
(17, 'Kid\'s Collection', 'kids-collection', 0, 'uploads/category/category_image_15999.png', 1, 1, '2021-02-12 11:06:52', 1, NULL, NULL, 0, NULL, NULL),
(18, 'Shirt', 'shirt', 17, NULL, 0, 1, '2021-02-12 11:07:12', 1, NULL, NULL, 0, NULL, NULL);
...
CREATE TABLE `product_colors` (
  ...
  `color_code` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `product_colors` (`id`, `title`, `color_code`, `description`, `status`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted`, `deleted_at`, `deleted_by`) VALUES
(1, 'Black', '#000000', NULL, 1, '2021-02-01 09:59:13', 1, NULL, NULL, 0, NULL, NULL),
(2, 'Red', '#ff0000', NULL, 1, '2021-02-01 09:59:41', 1, '2021-02-01 10:00:35', 1, 0, NULL, NULL);
...
CREATE TABLE `product_images` (
  ...
  `image_type` tinyint(3) UNSIGNED NOT NULL COMMENT '1=main-image,2=gallery-image',
  `status` tinyint(3) UNSIGNED NOT NULL DEFAULT '0' COMMENT '0=Inactive,1=Active',
  `created_at` timestamp NULL DEFAULT NULL,
  `created_by` int(10) UNSIGNED DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `product_images` (`id`, `product_id`, `image`, `image_type`, `status`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted`, `deleted_at`, `deleted_by`) VALUES
(1, 5, 'uploads/product/product_image_11804.png', 1, 1, '2021-02-01 11:02:58', 1, NULL, NULL, 0, NULL, NULL),
(3, 6, 'uploads/product/product_image_13414.png', 1, 1, '2021-02-01 11:03:53', 1, NULL, NULL, 0, NULL, NULL),
(5, 5, 'uploads/product/product_image_11499.png', 2, 1, '2021-02-01 12:49:44', 1, NULL, NULL, 0, NULL, NULL),
(6, 7, 'uploads/product/product_image_11038.jpg', 1, 1, '2021-02-06 08:24:01', 1, NULL, NULL, 0, NULL, NULL),
(7, 8, 'uploads/product/product_image_14845.png', 1, 1, '2021-03-12 23:11:23', 1, NULL, NULL, 0, NULL, NULL),
(9, 9, 'uploads/product/product_image_19525.png', 1, 1, '2021-03-18 10:16:57', 1, NULL, NULL, 0, NULL, NULL),
(10, 10, 'uploads/product/product_image_17286.jpg', 1, 1, '2021-10-05 20:05:58', 1, NULL, NULL, 0, NULL, NULL);
...
CREATE TABLE `product_reviews` (
  ...
  `review_rate` decimal(5,2) NOT NULL,
  `review_text` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `verified_review` tinyint(4) NOT NULL DEFAULT '0' COMMENT '0=unverified,1=verified',
  `status` tinyint(3) UNSIGNED NOT NULL DEFAULT '0' COMMENT '0=Inactive,1=Active',
  `created_at` timestamp NULL DEFAULT NULL,
  `created_by` int(10) UNSIGNED DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `product_stocks` (`id`, `product_id`, `product_color_id`, `total_quantity`, `ordered_quantity`, `sold_quantity`, `available_quantity`, `status`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted`, `deleted_at`, `deleted_by`) VALUES
(1, 5, 1, 13, 0, 0, 13, 1, '2021-02-01 14:03:43', 1, NULL, NULL, 0, NULL, NULL),
(2, 5, 2, 26, 0, 0, 26, 1, '2021-02-01 14:03:43', 1, NULL, NULL, 0, NULL, NULL),
(3, 9, 0, 10, 0, 0, 10, 1, '2021-03-18 22:19:31', 1, NULL, NULL, 0, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `product_stock_input_histories`
--

CREATE TABLE `product_stock_input_histories` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `product_stock_input_histories`
--

INSERT INTO `product_stock_input_histories` (`id`, `product_stock_id`, `product_id`, `product_color_id`, `total_quantity`, `status`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted`, `deleted_at`, `deleted_by`) VALUES
(1, 1, 5, 1, 13, 1, '2021-02-01 14:03:43', 1, NULL, NULL, 0, NULL, NULL),
(2, 2, 5, 2, 26, 1, '2021-02-01 14:03:43', 1, NULL, NULL, 0, NULL, NULL),
(3, 3, 9, 0, 10, 1, '2021-03-18 22:19:31', 1, NULL, NULL, 0, NULL, NULL);
...
CREATE TABLE `system_settings` (
  ...
  `contact_telephone` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contact_email` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contact_location` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `contact_us_text` text COLLATE utf8mb4_unicode_ci,
  `status` tinyint(3) UNSIGNED NOT NULL DEFAULT '0' COMMENT '0=Inactive,1=Active',
  `created_at` timestamp NULL DEFAULT NULL,
  `created_by` int(10) UNSIGNED DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
CREATE TABLE `unions` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `upazilla_id` int(10) UNSIGNED NOT NULL,
  `name` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `bn_name` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `url` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `users` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `type` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'type of user',
  `role` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'user role id',
  ...
  `dob` date DEFAULT NULL COMMENT 'user birth date',
...
INSERT INTO `users` (`id`, `type`, `role`, `username`, `mobile`, `email`, `password`, `first_name`, `last_name`, `profile_picture`, `dob`, `gender`, `email_verified_at`, `remember_token`, `status`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted`, `deleted_at`, `deleted_by`) VALUES
(1, 'admin', 'admin', 'admin', '01700000000', 'admin@gmail.com', '$2y$10$LbyxUn2OzFINtpcJzQdnOOtXInW8EVC5CWUwwa2Lv/exFQu7kzpwO', 'Alexandera', 'Pierce', NULL, NULL, NULL, '2021-02-01 09:06:28', 'kFHpuoQyOWh96spjl7WbEB3HnvbwhApjOjRbSpuOgzFI08yrThQDzE0Y4Q4p', 1, '2021-02-01 09:06:28', NULL, '2021-02-02 06:39:35', 1, 0, NULL, NULL),
(2, 'customer', 'customer', 'customer', '01700005005', 'customer@gmail.com', '$2y$10$MyaXjpIpIQodSJkrug0zi.T4Uqa7fLdEvYFJdmYIOWternXOLjgm.', 'Allaia', 'Customer', NULL, NULL, NULL, '2021-02-01 09:06:29', 'LqgoqYgAAvF6Z9p0FuJFdvyoZUXZmGu8GhXMVc9LSYFz6J5EN3XuV4Ocqeu0', 1, '2021-02-01 09:06:29', NULL, NULL, NULL, 0, NULL, NULL),
(3, 'customer', 'role', NULL, NULL, 'hezacyw@jytovofivike.com', '$2y$10$lJkmOvREKhAu.VMouNAhXOECqdKAI60mldgRjRwKbVa4gUe3Y0o42', 'Ahmed', 'Burch', NULL, NULL, NULL, '2021-10-02 01:59:42', NULL, 1, '2021-10-02 01:59:42', NULL, NULL, NULL, 0, NULL, NULL),
(4, 'customer', 'role', NULL, '+1 (756) 996-7571', 'busywa@zyzagenuxino.com', '$2y$10$6qbd7CAA9q6A9Sq9IZVEJ.IsmNZC6UweAVz/T6gFjgjWBG5z/IlJq', 'Ezekiel', 'Brown', NULL, NULL, NULL, '2021-10-02 02:00:55', NULL, 1, '2021-10-02 02:00:55', NULL, NULL, NULL, 0, NULL, NULL),
(5, 'customer', 'role', NULL, '+1 (656) 879-5947', 'boxicubos@zog.com', '$2y$10$1fqh14bzf/pVbkBk4QxtM.d8JlThKqtpkS4oMST/xuxHwdwcUpyKy', 'Keelie', 'Mcintyre', NULL, NULL, NULL, '2021-10-02 02:01:16', NULL, 1, '2021-10-02 02:01:16', NULL, NULL, NULL, 0, NULL, NULL),
(6, 'customer', 'customer', NULL, '+1 (748) 421-4172', 'zavododyfe@diwic.com', '$2y$10$P4Y6Z5xxOAUGfOMeopv8DOx3.9zuJ0lu8ZW6XfcB6EcRD0crDOK9e', 'Taylor', 'Pruitt', NULL, NULL, NULL, '2021-10-02 02:02:15', NULL, 1, '2021-10-02 02:02:15', NULL, NULL, NULL, 0, NULL, NULL);
...
CREATE TABLE `user_addresses` (
  ...
  `post_code` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `address` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `address_type` tinyint(4) NOT NULL DEFAULT '1' COMMENT '1=normal,2=default',
  `status` tinyint(3) UNSIGNED NOT NULL DEFAULT '0' COMMENT '0=Inactive,1=Active',
  `created_at` timestamp NULL DEFAULT NULL,
  `created_by` int(10) UNSIGNED DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `user_addresses` (`id`, `user_id`, `full_name`, `phone_number`, `division_id`, `district_id`, `upazila_id`, `post_code`, `address`, `address_type`, `status`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted`, `deleted_at`, `deleted_by`) VALUES
(1, 2, 'Shay1 Ora1', '01958585896', 7, 57, 432, '5700', 'klsjf', 2, 1, '2021-03-05 05:27:02', 2, NULL, NULL, 0, NULL, NULL),
(2, 2, 'Aimee Snider', '+19464441405', 2, 14, 123, '3', 'Sint voluptates qui\r\nCupidatat praesentiu', 1, 1, '2021-09-26 10:08:31', 2, NULL, NULL, 0, NULL, NULL),
(3, 3, 'Ahmed Burch', '+1 (686) 278-2868', 7, 54, 410, 'Ut ipsum lorem ullam', 'Quia irure sunt elit', 2, 1, '2021-10-02 01:59:42', 3, NULL, NULL, 0, NULL, NULL),
(4, 4, 'Ezekiel Brown', '+1 (756) 996-7571', 5, 37, 286, 'Aliquam debitis aliq', 'Elit est ipsum par', 2, 1, '2021-10-02 02:00:55', 4, NULL, NULL, 0, NULL, NULL),
(5, 5, 'Keelie Mcintyre', '+1 (656) 879-5947', 7, 53, 400, 'Possimus voluptas e', 'Nisi soluta commodi', 2, 1, '2021-10-02 02:01:16', 5, NULL, NULL, 0, NULL, NULL),
(6, 6, 'Taylor Pruitt', '+1 (748) 421-4172', 4, 33, 250, 'Hic et enim eiusmod', 'Ducimus placeat om', 2, 1, '2021-10-02 02:02:15', 6, NULL, NULL, 0, NULL, NULL);
...
CREATE TABLE `website_information` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `website_title` varchar(225) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `website_short_name` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `facebook_url` varchar(225) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `twitter_url` varchar(225) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pinterest_url` varchar(225) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `instagram_url` varchar(225) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` tinyint(3) UNSIGNED NOT NULL DEFAULT '0' COMMENT '0=Inactive,1=Active',
  `created_at` timestamp NULL DEFAULT NULL,
  `created_by` int(10) UNSIGNED DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
...
INSERT INTO `website_information` (`id`, `website_title`, `website_short_name`, `email`, `phone_number`, `logo`, `favicon`, `facebook_url`, `twitter_url`, `pinterest_url`, `instagram_url`, `status`, `created_at`, `created_by`, `updated_at`, `updated_by`, `deleted`, `deleted_at`, `deleted_by`) VALUES
(1, 'Allaia Shop', 'Allaia', 'dusagyr@hufuzer.com', '+1 (865) 158-4932', 'uploads/logo/logo_11560.png', 'uploads/logo/favicon_11655.png', 'Ut possimus nostrud', 'Ipsum odio irure ra', 'Cillum est non nobis', 'Ipsum odio irure ra', 1, '2021-02-02 08:53:59', 1, '2021-10-02 06:18:13', 1, 0, NULL, NULL);
...
--
-- Indexes for table `product_stock_input_histories`
--
ALTER TABLE `product_stock_input_histories`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `product_stock_input_histories`
--
ALTER TABLE `product_stock_input_histories`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
